...
if(isset($_POST['submit'])){
    ...
    $query = "UPDATE Roll SET Is_Strike = $isStrike, Is_Spare = $isSpare, Is_Foul = $isFoul, Hit_Pin_1 = $pinHit[0], Hit_Pin_2 = $pinHit[1], Hit_Pin_3 = $pinHit[2], Hit_Pin_4 = $pinHit[3], Hit_Pin_5 = $pinHit[4], Hit_Pin_6 = $pinHit[5], Hit_Pin_7 = $pinHit[6], Hit_Pin_8 = $pinHit[7], Hit_Pin_9 = $pinHit[8], Hit_Pin_10 = $pinHit[9] WHERE Roll_ID = $rollID";
